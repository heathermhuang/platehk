      ...
      const I18N = {
        zh: {
          h1: "hk.app 香港小應用",
          sub: "收錄香港相關的小工具與小應用",
          lead: "第一個案例：香港車牌拍賣資料庫（支援自訂車牌 PVRM、傳統車牌 TVRM）。",
        ...
        en: {
          ...
          lead: "First featured app: HK Vehicle Registration Marks Database (PVRM + TVRM).",
          chips: ["Search", "PDF links", "Sorting", "Issues & paging", "ZH/EN"],
          c1t: "HK Vehicle Registration Marks Database",
