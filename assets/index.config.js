const INDEX_I18N = {
        zh: {
          ...
          auctionAgendaTitle: "拍賣日程",
          auctionAgendaNote: "正在開放及即將舉行的官方申請、拍牌易和實體拍賣。",
          auctionAgendaStatusOpen: "開放中",
          auctionAgendaStatusUpcoming: "即將開始",
          auctionAgendaStatusClosed: "已完結",
          auctionAgendaTypeRegistration: "登記窗口",
          auctionAgendaTypeOnline: "網上拍賣",
          auctionAgendaTypePhysical: "實體拍賣",
          auctionAgendaPvrmWindowTitle: "自訂車牌 PVRM 申請窗口",
          auctionAgendaPvrmWindowBody: "PVRM 一般於每年 1 月、5 月及 9 月接受申請；提交前請以運輸署頁面核對最新邀請詳情。",
          auctionAgendaEauctionTitle: "拍牌易 E-Auction 普通車牌拍賣",
          auctionAgendaEauctionBody: "普通傳統車牌網上競投，不包括「HK」/「XX」字首、特殊車牌及自訂車牌。",
          auctionAgendaTvrmPhysicalTitle: "傳統車牌 TVRM 實體拍賣",
          auctionAgendaTvrmPhysicalBody: "實體拍賣處理「HK」/「XX」字首及特殊登記號碼。",
          auctionAgendaPvrmPhysicalTitle: "自訂車牌 PVRM 實體拍賣",
          auctionAgendaPvrmPhysicalBody: "自訂登記號碼以實體舉牌拍賣形式出售。",
          auctionAgendaActionOpen: "前往平台",
          auctionAgendaActionDetails: "官方詳情",
          auctionAgendaActionApplication: "申請頁",
          auctionAgendaActionAuctionPage: "拍賣頁",
          auctionAgendaActionHandout: "PDF 詳情",
          auctionAgendaSliderControls: "拍賣日程滑動控制",
          auctionAgendaSliderPrevious: "顯示較早的拍賣日程",
          auctionAgendaSliderNext: "顯示較後的拍賣日程",
          auctionAgendaSliderRange: (start, end, total) => `${start}–${end} / ${total}`,
          auctionAgendaVerifyNote: "日程以本次建置時可見的官方頁面整理；競投或申請前請再次核對運輸署及拍牌易網站。",
          auctionAgendaEmpty: "目前沒有已內置日期的開放或即將舉行活動；請到官方頁面核對最新公告。",
          ...
          emptyStateHintSearch: "沒有收錄拍賣紀錄，不代表號碼未被分配或正在放售。可縮短關鍵字或查看官方可用號碼服務。",
          invalidQuery: "請輸入英文字母或數字（不接受 Q）；I 及 O 會視為 1 及 0。",
          searchFailed: "搜尋服務暫時未能回應。這不是零筆結果，請重試。",
          retrySearch: "重新搜尋", checkAvailability: "官方可用號碼與申請", findAlternatives: "按預算找車牌", plateDetails: "查看車牌紀錄及比較",
          headerTitle: "香港車牌拍賣資料庫",
          headerAll: "全部車牌",
        ...
        en: {
          ...
          auctionAgendaTitle: "Auction Calendar",
          auctionAgendaNote: "Open and upcoming official registration, E-Auction, and physical auction events.",
          auctionAgendaStatusOpen: "Open now",
          auctionAgendaStatusUpcoming: "Upcoming",
          auctionAgendaStatusClosed: "Closed",
          auctionAgendaTypeRegistration: "Registration window",
          auctionAgendaTypeOnline: "Online auction",
          auctionAgendaTypePhysical: "Physical auction",
          auctionAgendaPvrmWindowTitle: "PVRM application window",
          auctionAgendaPvrmWindowBody: "PVRM applications usually open in January, May, and September; verify the latest invitation details on the TD page before submitting.",
          auctionAgendaEauctionTitle: "E-Auction ordinary TVRM auction",
          auctionAgendaEauctionBody: "Online bidding for ordinary traditional marks, excluding HK/XX prefixes, special marks, and personalized marks.",
          auctionAgendaTvrmPhysicalTitle: "TVRM physical auction",
          auctionAgendaTvrmPhysicalBody: "Physical paddle auction for HK/XX prefix marks and special registration marks.",
          auctionAgendaPvrmPhysicalTitle: "PVRM physical auction",
          auctionAgendaPvrmPhysicalBody: "Personalized marks are sold by physical paddle auction.",
          auctionAgendaActionOpen: "Open platform",
          auctionAgendaActionDetails: "Official details",
          auctionAgendaActionApplication: "Application page",
          auctionAgendaActionAuctionPage: "Auction page",
          auctionAgendaActionHandout: "PDF handout",
          auctionAgendaSliderControls: "Auction calendar slider controls",
          auctionAgendaSliderPrevious: "Show earlier auction events",
          auctionAgendaSliderNext: "Show later auction events",
          auctionAgendaSliderRange: (start, end, total) => `${start}–${end} / ${total}`,
          auctionAgendaVerifyNote: "This agenda reflects official pages visible at build time; re-check TD and E-Auction before applying or bidding.",
          auctionAgendaEmpty: "No dated open or upcoming event is bundled in this build; check the official pages for the latest notices.",
          ...
          emptyStateHintSearch: "No auction record does not mean this mark is unassigned or for sale. Try a shorter query or the official availability service.",
          invalidQuery: "Use letters and numbers (Q is not allowed). I and O are treated as 1 and 0.",
          searchFailed: "Search is temporarily unavailable. This is not a zero-result search. Please retry.",
          retrySearch: "Retry search", checkAvailability: "Official availability and applications", findAlternatives: "Find plates by budget", plateDetails: "View plate history and comparisons",
          headerTitle: "HK Vehicle Registration Marks Database",
      ...
      const brokerCloseEl = document.getElementById("brokerClose");
      const brokerFormEl = document.getElementById("brokerForm");
      const brokerPlateEl = document.getElementById("brokerPlate");
      const brokerBudgetEl = document.getElementById("brokerBudget");
      const brokerNoteEl = document.getElementById("brokerNote");
      const brokerSubmitEl = document.getElementById("brokerSubmit");
      ...
      const INDEX_DATASETS = {
        all: {
          titleZh: "香港全部車牌拍賣資料庫",
          titleEn: "All HK Vehicle Registration Marks Database",
          children: ["pvrm", "tvrm_physical", "tvrm_eauction", "tvrm_legacy"],
        },
        pvrm: {
          titleZh: "香港自訂車牌拍賣資料庫",
          titleEn: "Personalized Vehicle Registration Marks Database",
          base: "./data",
        },
        tvrm_physical: {
          titleZh: "香港傳統車牌（實體拍賣）資料庫",
          titleEn: "Traditional Vehicle Registration Marks Physical Auction Database",
          base: "./data/tvrm_physical",
        },
        tvrm_eauction: {
          titleZh: "香港傳統車牌（拍牌易網上拍賣）資料庫",
          titleEn: "Traditional Vehicle Registration Marks E-Auction Database",
          base: "./data/tvrm_eauction",
        },
        tvrm_legacy: {
          titleZh: "香港傳統車牌（1973-2006 年）資料庫",
          titleEn: "Traditional Vehicle Registration Marks 1973-2006 Database",
